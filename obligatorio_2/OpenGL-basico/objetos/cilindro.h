...
public:
    cilindro(vector3 pos, vector3 color , float alfa ,float bri, float reflc,float translucido, float indiceRef , float rad, float alt )
        :objeto(pos, color , alfa, reflc, translucido , indiceRef , bri), altura(alt), radio(rad), top(pos+vector3(0, altura, 0), vector3(0,1,0), color , alfa ,bri, reflc, translucido, indiceRef, radio, radio), base(pos,vector3(0,-1,0),color,
